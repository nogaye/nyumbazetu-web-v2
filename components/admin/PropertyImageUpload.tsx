      ...
      {showGuidance && propertyId && (
        <Alert className="border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20">
          ...
          <div className="flex-1">
            <AlertTitle className="text-blue-800 dark:text-blue-200 flex items-center justify-between mb-2">
              <span>Image Upload Best Practices</span>
              <button
              ...
              <div className="space-y-3 text-sm">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="space-y-2">
                    <p className="font-semibold text-blue-900 dark:text-blue-100 flex items-center gap-1">
                      <CheckCircleIcon className="h-4 w-4" />
                      Image Quality
                    </p>
                    <ul className="list-disc list-inside space-y-1 ml-2 text-xs">
                      <li>High resolution (min 1200px width)</li>
                      <li>Landscape orientation (16:9 or 4:3)</li>
                      <li>WebP or JPEG format</li>
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2 text-xs">
                      <li>First image = Cover (auto-selected)</li>
                      <li>Exterior → Living → Bedrooms</li>
                      <li>Kitchen → Bathroom → Other</li>
                      <li>Reorder anytime with arrows</li>
                    </ul>
                  </div>
                </div>
                <div className="pt-2 border-t border-blue-200 dark:border-blue-700">
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-2 text-xs">
                    <li>Keep rooms tidy and decluttered for professional appearance</li>
                    <li>Use natural daylight when possible for better color accuracy</li>
                    <li>Ensure photos are level and straight (avoid tilted angles)</li>
                    <li>Click the star icon ⭐ on any image to set it as the cover</li>
                  </ul>
                </div>
              </div>
            </AlertDescription>
